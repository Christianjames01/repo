    ...
    if (isset($_POST['update_complaint'])) {
        ...
        if (empty($errors)) {
            ...
            if ($update_stmt->execute()) {
                ...
                // SEND NOTIFICATIONS USING createNotification function
                ...
                if ($user_row = $user_result->fetch_assoc()) {
                    ...
                    if ($new_status === 'Resolved') {
                        createNotification(
                            ...
                            $complainant_user_id,
                            'Complaint Resolved',
                            "Your complaint \"" . $complaint['subject'] . "\" has been resolved. Thank you for your patience.",
                            'complaint_resolved',
                            $complaint_id,
                            'complaint'
                        );
                        ...
                        createNotification(
                            ...
                            $complainant_user_id,
                            'Complaint Closed',
                            "Your complaint \"" . $complaint['subject'] . "\" has been closed. If you have further concerns, please file a new complaint.",
                            'complaint_closed',
                            $complaint_id,
                            'complaint'
                        );
                        ...
                        createNotification(
                            ...
                            "Your complaint \"" . $complaint['subject'] . "\" status has been updated to: $new_status",
                    ...
                    if ($responder_id && $responder_id != $complainant_user_id && $responder_id != $complaint['assigned_to']) {
                        ...
                        createNotification(
                            ...
                            "You have been assigned to handle complaint: \"" . $complaint['subject'] . "\"",
                        ...
                        createNotification(
                            ...
                            $complainant_user_id,
                            'Complaint Assigned',
                            "Your complaint has been assigned to $staff_name for handling.",
                            'complaint_assignment',
                            $complaint_id,
                            'complaint'
                        );
...
.attachment-card:hover .attachment-image img {
...
$upload_url  = '/barangaylink1/uploads/complaints/'; // for displaying in <img src="">
                    $attachments = [];
                    ...
                    <div class="mt-4">
                        ...
                        <div class="attachment-gallery">
                            ...
                            <div class="attachment-card">
                                <?php if ($is_image): ?>
                                    <a href="<?php echo $file_path; ?>" target="_blank" class="attachment-image">
                                        <img src="<?php echo $file_path; ?>" alt="Attachment">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo $file_path; ?>" target="_blank" class="text-decoration-none">
                                        <div class="attachment-file">
                                            <i class="fas fa-file fs-2 mb-2 text-primary"></i>
                                            <div class="text-uppercase fw-bold"><?php echo $file_ext; ?></div>
                                        </div>
                                        <div class="attachment-info">
                                            <small class="text-muted text-truncate d-block">
                                                <?php echo htmlspecialchars($file); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-item-value" style="display: block;">
                            <?php echo htmlspecialchars($complaint['address']); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-<?php echo $is_resident ? 'secondary' : 'warning'; ?> border-0 mb-0">
                        ...
                        <strong><?php echo $is_resident ? 'Status:' : 'Not Assigned'; ?></strong>
                        <br>
...
function confirmUpdate() {
    ...
    if (statusSelect.value === 'Closed') {
        ...
        setTimeout(() => {
            const confirmModal = new bootstrap.Modal(document.getElementById('closeComplaintModal'));
            confirmModal.show();
        }, 300);
    } else {
