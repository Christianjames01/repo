...
body.dark-mode .db-badge--danger {
    background: #2d1c1c !important;
...
body.dark-mode .db-alert--warning {
    background: #27211a !important;
    color: #fbbf24 !important;
...
body.dark-mode .db-file-card {
    background: #1e293b !important;
    border-color: #334155 !important;
}
body.dark-mode .db-file-card__icon {
    background: #243044 !important;
}
body.dark-mode .db-file-card__body {
    border-top-color: #334155 !important;
}
