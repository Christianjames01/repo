...
// If already verified, redirect to requests page
                ...
                <div class="card-body p-5 text-center">
                    ...
                    <?php if (empty($user_data['id_photo'])): ?>
                        <div class="alert alert-warning mb-4">
                            ...
                            <strong>Action Required:</strong> You need to upload your valid government-issued ID to access the document request system.
                        </div>
                    <?php else: ?>
                    ...
                    <div class="info-card text-start mb-4">
                        ...
                        <p class="mb-2">
                            Verification ensures the security and integrity of our barangay document system. It helps us:
                        </p>
                        <ul class="mb-0">
                            <li>Confirm your identity as a legitimate resident</li>
                            <li>Prevent fraudulent document requests</li>
                            <li>Protect your personal information</li>
                            <li>Ensure only authorized residents access barangay services</li>
                        </ul>
                    </div>
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-item <?php echo $user_data['is_verified'] == 1 ? 'completed' : ''; ?>">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p class="text-muted small mb-0">
                                        Once verified, you can access all barangay services
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-start mb-4">
                        ...
                        <div class="feature-box">
                            ...
                            <strong>Request Barangay Documents</strong>
                            <p class="mb-0 text-muted small">
                                Barangay Clearance, Certificates, Permits, and more
                            </p>
                        </div>
                        <div class="feature-box">
                            ...
                            <p class="mb-0 text-muted small">
                                Real-time updates on your document requests
                            </p>
                        </div>
                        <div class="feature-box">
                            ...
                            <p class="mb-0 text-muted small">
                                Access all your past and current requests
                            </p>
                        </div>
                        <div class="feature-box">
                            ...
                            <p class="mb-0 text-muted small">
                                Stay updated on announcements and events
                            </p>
                        </div>
                    </div>
