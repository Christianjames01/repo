...
body.dark-mode .db-ann--normal {
    background: #1e293b;
}

body.dark-mode .db-ann--high {
    background: #2a2310;
}

body.dark-mode .db-ann--urgent {
    background: #2a1520;
}

/* Activity timeline cards */
body.dark-mode .db-timeline__item--upcoming .db-timeline__card {
    background: #1a2744;
    border-color: #2d4a7a;
}

body.dark-mode .db-timeline__item--today .db-timeline__card {
    background: #2a2010;
    border-color: #5a4a20;
}

body.dark-mode .db-timeline__item--past .db-timeline__card {
    background: #1e293b;
}
...
body.dark-mode .db-delete-target {
    background: #243044;
    border-color: #334155;
    color: #e2e8f0;
}
...
/* Panel footer */
body.dark-mode .db-panel__footer {
    background: #243044;
    border-color: #334155;
}
...
body.dark-mode .db-btn--outline {
    color: #93c5fd;
    border-color: #93c5fd;
}

body.dark-mode .db-btn--outline:hover {
    background: #1d4ed8;
    color: #fff;
    border-color: #1d4ed8;
}
...
/* Stat cards */
body.dark-mode .db-stat-card__num {
    color: #f1f5f9;
}
...
/* Gallery */
body.dark-mode .db-gallery__item {
    border-color: #334155;
    background: #243044;
}
