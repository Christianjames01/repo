...
// If already verified, redirect to blotter page
                ...
                <div class="card-body p-5 text-center">
                    ...
                    <?php if (empty($user_data['id_photo'])): ?>
                        <div class="alert alert-warning mb-4">
                            ...
                            <strong>Action Required:</strong> You need to upload your valid government-issued ID to file blotter complaints.
                        </div>
                    <?php else: ?>
                    ...
                    <div class="info-card text-start mb-4">
                        <h5 class="mb-3">
                            ...
                            Why do I need to be verified to file blotter complaints?
                        </h5>
                        <p class="mb-2">
                            Verification ensures the legitimacy of blotter complaints filed in our barangay system. It helps us:
                        </p>
                        <ul class="mb-0">
                            <li>Verify that complaints come from legitimate residents</li>
                            <li>Prevent anonymous or fraudulent complaints</li>
                            <li>Enable proper follow-up and communication with involved parties</li>
                            <li>Maintain accountability in the complaint resolution process</li>
                            <li>Protect all parties involved in blotter cases</li>
                            <li>Ensure legal documentation is properly attributed</li>
                        </ul>
                    </div>
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-item <?php echo $user_data['is_verified'] == 1 ? 'completed' : ''; ?>">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p class="text-muted small mb-0">
                                        Once verified, you can file and track blotter complaints
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-start mb-4">
                        ...
                        <div class="feature-box">
                            ...
                            <strong>File Blotter Complaints</strong>
                            <p class="mb-0 text-muted small">
                                Submit complaints about disputes, disturbances, theft, and other incidents
                            </p>
                        </div>
                        <div class="feature-box">
                            ...
                            <p class="mb-0 text-muted small">
                                Monitor the progress of your filed blotter complaints in real-time
                            </p>
                        </div>
                        <div class="feature-box">
                            <i class="fas fa-history"></i>
                            <strong>View Blotter History</strong>
                            <p class="mb-0 text-muted small">
                                Access all your past and current blotter records
                            </p>
                        </div>
                        <div class="feature-box">
                            ...
                            <p class="mb-0 text-muted small">
                                Receive official documentation for your blotter cases
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 pt-4 border-top">
                        <p class="text-muted small mb-0">
                            ...
                            Need help? Contact us at the barangay office or call 
                            <strong><?php echo htmlspecialchars($user_data['contact_number'] ?? '(Contact Number)'); ?></strong>
                        </p>
                    </div>
                </div>
            </div>
